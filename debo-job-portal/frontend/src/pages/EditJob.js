...
const EditJob = () => {
  ...
  const fetchJob = async () => {
    try {
      ...
      if (response.success) {
        ...
        setFormData({
          title: job.title || '',
          company: job.company || 'Debo Engineering',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await jobsService.updateJob(id, formData);
      if (response.success) {
        ...
        setError(response.message || 'Failed to update job posting');
      }
    } catch (error) {
      setError('Error updating job posting');
    } finally {
      setSaving(false);
    }
  };
    ...
    if (window.confirm('Are you sure you want to delete this job posting? This action cannot be undone.')) {
      try {
        ...
        if (response.success) {
          ...
          setError(response.message || 'Failed to delete job posting');
        }
      } catch (error) {
    ...
    <div className="edit-job-page">
      <div className="container">
        <div className="page-header">
          ...
          <p>Update the job vacancy information</p>
        </div>
